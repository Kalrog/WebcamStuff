...
public class Display extends JFrame implements ComponentListener {
	...
	public JSlider min = new JSlider(JSlider.HORIZONTAL, 0, 4000, 2000);
	public JSlider max = new JSlider(JSlider.HORIZONTAL, 0, 4000, 2000);
	...
	public Display(int width, int height) {
	    ...
	    panel.add(check6);
	    panel.add(min);
	    min.setMajorTickSpacing(1000);
	    min.setMinorTickSpacing(100);
	    min.setPaintTicks(true);
	    min.setPaintLabels(true);
	    panel.add(max);
	    max.setMajorTickSpacing(1000);
	    max.setMinorTickSpacing(100);
